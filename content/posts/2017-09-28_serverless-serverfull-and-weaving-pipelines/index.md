...
lastmod: 2017-09-28T02:30:16.110Z

description: ""

subtitle: "Serverless computing is a hot topic these days."
tags:
  - Serverless
  - AWS
  - go
...
![image](/posts/2017-09-28_serverless-serverfull-and-weaving-pipelines/images/1.jpeg#layoutFillWidth)
...
![image](/posts/2017-09-28_serverless-serverfull-and-weaving-pipelines/images/2.jpeg#layoutOutsetLeft)
...
![image](/posts/2017-09-28_serverless-serverfull-and-weaving-pipelines/images/3.jpeg#layoutOutsetLeft)
...
Your [_buildspec.yml_](https://github.com/mweagle/SpartaCodePipeline/blob/master/buildspec.yml) \_\_ file’s lifecycle hooks can be broken down into the following lifecycle stages:
...
Now that you have configured everything, it’s time to run the new _provisionPipeline_ command and wait for completion.
