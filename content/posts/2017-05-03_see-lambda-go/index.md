...
lastmod: 2017-05-03T03:16:28.419Z
...
![image](/posts/2017-05-03_see-lambda-go/images/3.png#layoutOutsetLeft)
...
{{< gist mweagle 0b2194e35d850786bf1ae8b114685dcd >}}

### After

{{< gist mweagle 51128a557ca7f36b1af3a293833c99d5 >}}
...
![image](/posts/2017-05-03_see-lambda-go/images/4.png#layoutOutsetLeft)
...
```shell
INFO[0000] Building cgolibrary in Docker Args=[run — rm -v /Users/mweagle/Documents/gopath:/usr/src/gopath -w /usr/src/gopath/src/github.com/mweagle/SpartaPython/cgo -e GOPATH=/usr/src/gopath -e GOOS=linux -e GOARCH=amd64 golang:1.8.1 go build -o SpartaHelloPythonCGO.lambda.so -tags lambdabinary linux -buildmode=c-shared -tags lambdabinary noop ] Name=SpartaHelloPythonCGO.lambda.so
```
...
![image](/posts/2017-05-03_see-lambda-go/images/5.png#layoutOutsetLeft)
...
{{< gist mweagle 2648a75a5989fbb541ba405476a68494 >}}
...
{{< gist mweagle 708637c449315034045178a8716e8f39 >}}
...
![image](/posts/2017-05-03_see-lambda-go/images/6.png#layoutOutsetLeft)
...
![image](/posts/2017-05-03_see-lambda-go/images/7.png#layoutOutsetCenter)
